...
def test(model, loader):
    ...
    # --- MODIFIED: Calculate additional metrics ---
    ...
    return p, r, f1, acc, cm  # Return the new metrics
...
def main():
    ...
    for epoch in range(1, cfg.EPOCHS + 1):
        ...
        val_p, val_r, val_f1,  val_acc, _ = test(model, val_loader) # Unpack new metrics
    ...
    # --- MODIFIED: Evaluate and save all metrics ---
