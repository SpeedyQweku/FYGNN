...
pd.options.mode.chained_assignment = None # Suppress future warnings
...
def preprocess_data(nodes_df, edges_df):
    ...
    """
    # --- Filter out nodes that don't have a 200 status code ---
    ...
    sns.heatmap(correlation_matrix, cmap='coolwarm', annot=False) # Annotations are off for readability with many features
    ...
    preprocessor = {
        ...
        "scaler": scaler,
        "imputation_values": imputation_values, # <-- ADD THIS
        "feature_order": {
