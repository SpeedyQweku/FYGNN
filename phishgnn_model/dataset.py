...
from dataprep import load_data, preprocess_data  # Only import the one preprocessor
...
class PhishingDataset(InMemoryDataset):
    ...
    def process(self):
        ...
        val_indices, test_indices = train_test_split(
            temp_indices,
            test_size=0.5, # Split the remaining data 50/50
            stratify=labels[temp_indices], # Stratify again on the subset
            random_state=42
        )
