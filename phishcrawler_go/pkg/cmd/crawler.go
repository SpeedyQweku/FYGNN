...
func NewCrawler() (*Crawler, error) {
	...
	transport := &http.Transport{
		...
		TLSClientConfig:     &tls.Config{InsecureSkipVerify: true}, // Be cautious with this
	}

	httpClient := &http.Client{
		Transport: transport,
		Timeout:   20 * time.Second, // A generous timeout for the entire request
	}
